...
#include "FLIPSIDEUserFacingExperienceDefinition.generated.h"
...
class UFlipsideUserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="FlipsideExperienceDefinition"))
	...
	/** If true, this gamemode will show up as an LTM in the frontend */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience)
	bool bLimitedTimeMode = false;

	/** The date the gamemode released. */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience)
	FText DateOfGameModeRelease;
