...
#include "FlipsideExperienceDefinition.h"
...
void ULyraExperienceManagerComponent::SetCurrentExperience(FPrimaryAssetId ExperienceId)
{
	...
	TSubclassOf<UFlipsideExperienceDefinition> AssetClass = Cast<UClass>(AssetPath.TryLoad());
	check(AssetClass);
	const UFlipsideExperienceDefinition* Experience = GetDefault<UFlipsideExperienceDefinition>(AssetClass);
...
const UFlipsideExperienceDefinition* ULyraExperienceManagerComponent::GetCurrentExperienceChecked() const
{
...
void ULyraExperienceManagerComponent::StartExperienceLoad()
{
	...
	UE_LOG(LogFlipsideExperience, Log, TEXT("EXPERIENCE: StartExperienceLoad(CurrentExperience = %s, %s)"),
	...
	//@TODO: Centralize this client/server stuff into the UFlipsideAssetManager
...
void ULyraExperienceManagerComponent::OnExperienceLoadComplete()
{
	...
	UE_LOG(LogFlipsideExperience, Log, TEXT("EXPERIENCE: OnExperienceLoadComplete(CurrentExperience = %s, %s)"),
		*CurrentExperience->GetPrimaryAssetId().ToString(),
		*GetClientServerContextString(this));
...
void ULyraExperienceManagerComponent::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	...
	if (LoadState == ELyraExperienceLoadState::Loaded)
	{
		...
		{
			UE_LOG(LogFlipsideExperience, Error, TEXT("Actions that have asynchronous deactivation aren't fully supported yet in Lyra experiences"));
		}
