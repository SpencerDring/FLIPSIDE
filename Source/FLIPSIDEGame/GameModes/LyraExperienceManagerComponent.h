...
DECLARE_MULTICAST_DELEGATE_OneParam(FOnLyraExperienceLoaded, const UFlipsideExperienceDefinition* /*Experience*/);
...
public:
	...
	const UFlipsideExperienceDefinition* GetCurrentExperienceChecked() const;
...
private:
	...
	TObjectPtr<const UFlipsideExperienceDefinition> CurrentExperience;
