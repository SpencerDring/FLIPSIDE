...
#include UE_INLINE_GENERATED_CPP_BY_NAME(FLIPSIDEExperienceDefinition)

#define LOCTEXT_NAMESPACE "LyraSystem"

UFlipsideExperienceDefinition::UFlipsideExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UFlipsideExperienceDefinition::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void UFlipsideExperienceDefinition::UpdateAssetBundleData()
{
