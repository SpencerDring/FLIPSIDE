...
struct FLIPSIDEGAME_API FLyraContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FLIPSIDEGAME_API FLyraContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FLIPSIDEGAME_API FLyraContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FLIPSIDEGAME_API FLyraContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
...
class FLIPSIDEGAME_API UAnimNotify_LyraContextEffects : public UAnimNotify
{
	GENERATED_BODY()
