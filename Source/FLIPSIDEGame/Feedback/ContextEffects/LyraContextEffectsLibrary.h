...
struct FLIPSIDEGAME_API FLyraContextEffects
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class FLIPSIDEGAME_API ULyraActiveContextEffects : public UObject
{
	GENERATED_BODY()
...
class FLIPSIDEGAME_API ULyraContextEffectsLibrary : public UObject
{
	GENERATED_BODY()
