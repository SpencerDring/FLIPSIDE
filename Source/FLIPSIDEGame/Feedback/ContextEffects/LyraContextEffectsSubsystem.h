...
class FLIPSIDEGAME_API ULyraContextEffectsSettings : public UDeveloperSettings
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class FLIPSIDEGAME_API ULyraContextEffectsSet : public UObject
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class FLIPSIDEGAME_API ULyraContextEffectsSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
