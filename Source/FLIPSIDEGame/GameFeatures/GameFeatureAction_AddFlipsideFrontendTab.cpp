...
#include "GameFeatureAction_AddFlipsideFrontendTab.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GameFeatureAction_AddFlipsideFrontendTab)

#define LOCTEXT_NAMESPACE "FlipsideGameFeatures"

//////////////////////////////////////////////////////////////////////
// UGameFeatureAction_AddFlipsideFrontendTab

void UGameFeatureAction_AddFlipsideFrontendTab::OnGameFeatureDeactivating(FGameFeatureDeactivatingContext& Context)
{
...
void UGameFeatureAction_AddFlipsideFrontendTab::AddAdditionalAssetBundleData(FAssetBundleData& AssetBundleData)
{
...
#if WITH_EDITOR
EDataValidationResult UGameFeatureAction_AddFlipsideFrontendTab::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void UGameFeatureAction_AddFlipsideFrontendTab::AddToWorld(const FWorldContext& WorldContext, const FGameFeatureStateChangeContext& ChangeContext)
{
...
void UGameFeatureAction_AddFlipsideFrontendTab::Reset(FPerContextData& ActiveData)
{
...
void UGameFeatureAction_AddFlipsideFrontendTab::HandleActorExtension(AActor* Actor, FName EventName, FGameFeatureStateChangeContext ChangeContext)
{
	FPerContextData& ActiveData = ContextData.FindOrAdd(ChangeContext);
	...
	{
		AddFlipsideFrontendTab(Actor, ActiveData);
	}
}

void UGameFeatureAction_AddFlipsideFrontendTab::AddFlipsideFrontendTab(AActor* Actor, FPerContextData& ActiveData)
{
...
void UGameFeatureAction_AddFlipsideFrontendTab::RemoveWidgets(AActor* Actor, FPerContextData& ActiveData)
{
	ALyraHUD* HUD = CastChecked<ALyraHUD>(Actor);
