...
#include "GameFeatureAction_AddFlipsideFrontendTab.generated.h"
 ...
 */
UCLASS(MinimalAPI, meta = (DisplayName = "Add Flipside Frontend Tab"))
class UGameFeatureAction_AddFlipsideFrontendTab final : public UGameFeatureAction_WorldActionBase
{
	GENERATED_BODY()
...
private:
	...
	void AddFlipsideFrontendTab(AActor* Actor, FPerContextData& ActiveData);
