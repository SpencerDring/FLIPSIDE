 ...
 */
UCLASS(Config = Game)
class FLIPSIDEGAME_API ALyraPlayerState : public AModularPlayerState, public IAbilitySystemInterface, public ILyraTeamAgentInterface
{
	GENERATED_BODY()
...
private:
	void OnExperienceLoaded(const UFlipsideExperienceDefinition* CurrentExperience);
