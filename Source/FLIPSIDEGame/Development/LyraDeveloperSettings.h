...
class UFlipsideExperienceDefinition;
...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, config, Category=Lyra, meta=(AllowedTypes="FlipsideExperienceDefinition"))
	...
	*/
	...
	// Add game environment settings
	UPROPERTY(config, EditAnywhere, BlueprintReadWrite, Category=Lyra)
	TEnumAsByte<ServerEnvironment> ServerEnvironmentInEditor;
...
public:
	...
	FLIPSIDEGAME_API void OnPlayInEditorStarted() const;
