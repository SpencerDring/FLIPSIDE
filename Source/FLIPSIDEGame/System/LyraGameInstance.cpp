...
void ULyraGameInstance::Init()
{
	...
	{
		ComponentManager->RegisterInitState(FlipsideGameplayTags::InitState_Spawned, false, FGameplayTag());
		ComponentManager->RegisterInitState(FlipsideGameplayTags::InitState_DataAvailable, false, FlipsideGameplayTags::InitState_Spawned);
		ComponentManager->RegisterInitState(FlipsideGameplayTags::InitState_DataInitialized, false, FlipsideGameplayTags::InitState_DataAvailable);
		ComponentManager->RegisterInitState(FlipsideGameplayTags::InitState_GameplayReady, false, FlipsideGameplayTags::InitState_DataInitialized);
	}
