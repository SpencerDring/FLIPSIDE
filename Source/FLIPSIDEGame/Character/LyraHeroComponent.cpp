...
void ULyraHeroComponent::OnRegister()
{
	...
	if (!GetPawn<APawn>())
	{
		UE_LOG(LogFlipside, Error, TEXT("[ULyraHeroComponent::OnRegister] This component has been added to a blueprint whose base class is not a Pawn. To use this component, it MUST be placed on a Pawn Blueprint."));
...
bool ULyraHeroComponent::CanChangeInitState(UGameFrameworkComponentManager* Manager, FGameplayTag CurrentState, FGameplayTag DesiredState) const
{
	...
	if (!CurrentState.IsValid() && DesiredState == FlipsideGameplayTags::InitState_Spawned)
	{
	...
	else if (CurrentState == FlipsideGameplayTags::InitState_Spawned && DesiredState == FlipsideGameplayTags::InitState_DataAvailable)
	{
	...
	else if (CurrentState == FlipsideGameplayTags::InitState_DataAvailable && DesiredState == FlipsideGameplayTags::InitState_DataInitialized)
	{
		// Wait for player state and extension component
		ALyraPlayerState* LyraPS = GetPlayerState<ALyraPlayerState>();

		return LyraPS && Manager->HasFeatureReachedInitState(Pawn, ULyraPawnExtensionComponent::NAME_ActorFeatureName, FlipsideGameplayTags::InitState_DataInitialized);
	}
	else if (CurrentState == FlipsideGameplayTags::InitState_DataInitialized && DesiredState == FlipsideGameplayTags::InitState_GameplayReady)
	{
...
{
	if (CurrentState == FlipsideGameplayTags::InitState_DataAvailable && DesiredState == FlipsideGameplayTags::InitState_DataInitialized)
	{
		APawn* Pawn = GetPawn<APawn>();
		ALyraPlayerState* LyraPS = GetPlayerState<ALyraPlayerState>();
...
void ULyraHeroComponent::OnActorInitStateChanged(const FActorInitStateChangedParams& Params)
{
	...
	{
		if (Params.FeatureState == FlipsideGameplayTags::InitState_DataInitialized)
		{
...
{
	static const TArray<FGameplayTag> StateChain = { FlipsideGameplayTags::InitState_Spawned, FlipsideGameplayTags::InitState_DataAvailable, FlipsideGameplayTags::InitState_DataInitialized, FlipsideGameplayTags::InitState_GameplayReady };
...
void ULyraHeroComponent::BeginPlay()
{
	...
	ensure(TryToChangeInitState(FlipsideGameplayTags::InitState_Spawned));
	CheckDefaultInitialization();
}
		...
		if (const ULyraPawnData* PawnData = PawnExtComp->GetPawnData<ULyraPawnData>())
		{
			if (const ULyraInputConfig* InputConfig = PawnData->InputConfig)
			{
				...
				if (ensureMsgf(LyraIC, TEXT("Unexpected Input Component class! The Gameplay Abilities will not be bound to their inputs. Change the input component to ULyraInputComponent or a subclass of it.")))
				{
					...
					LyraIC->BindNativeAction(InputConfig, FlipsideGameplayTags::InputTag_Move, ETriggerEvent::Triggered, this, &ThisClass::Input_Move, /*bLogIfNotFound=*/ false);
					LyraIC->BindNativeAction(InputConfig, FlipsideGameplayTags::InputTag_Look_Mouse, ETriggerEvent::Triggered, this, &ThisClass::Input_LookMouse, /*bLogIfNotFound=*/ false);
					LyraIC->BindNativeAction(InputConfig, FlipsideGameplayTags::InputTag_Look_Stick, ETriggerEvent::Triggered, this, &ThisClass::Input_LookStick, /*bLogIfNotFound=*/ false);
					LyraIC->BindNativeAction(InputConfig, FlipsideGameplayTags::InputTag_Crouch, ETriggerEvent::Triggered, this, &ThisClass::Input_Crouch, /*bLogIfNotFound=*/ false);
					LyraIC->BindNativeAction(InputConfig, FlipsideGameplayTags::InputTag_AutoRun, ETriggerEvent::Triggered, this, &ThisClass::Input_AutoRun, /*bLogIfNotFound=*/ false);
				}
			}
		}
	}
